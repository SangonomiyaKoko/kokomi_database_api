    ...
    if (
        ...
        if 'hidden_profile' in temp_data['data'][aid]:
            ...
            for ship_id, ship_data in temp_data['data'][aid]['statistics'].items():
                ...
                result['data']['ships'][ship_id][type_index_list[index]] = del_useless_index(
...
a = update_recent_data(aid='2023619512', server='asia')
...
# cursorObj.execute(
#     'INSERT INTO recent_data(date, data) VALUES(?, ?)', ('2023-04-23', gzip.compress(bytes(str(a), encoding='utf-8'))))
# con.commit()
# con.close()
# print('插入数据成功')
